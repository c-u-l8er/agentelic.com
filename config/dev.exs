...
# Uses agentelic.* schema (migration range 080-089)
...
config :agentelic, AgentelicWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "nZQwet/1y3y1H2yHcdC3LrlA7FShvgUceg6Mhbe8OsDLt0pYiV0mSrjyO+ZyG6PF",
  watchers: []
...
config :agentelic, dev_routes: true
